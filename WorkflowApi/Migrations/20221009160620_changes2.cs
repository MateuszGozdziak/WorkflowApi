        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    rowColor = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTasks_AspNetUsers_LastUpdaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GanttEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GanttEvents_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_syncfiusionTask", x => x.Id);
                    table.ForeignKey(
                        name: "FK_syncfiusionTask_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTaskAudits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTaskAudits_AppTasks_EntityId",
                        column: x => x.EntityId,
                        principalTable: "AppTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppTaskAudits_AspNetUsers_UpdaterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppTaskAudits_EntityId",
                table: "AppTaskAudits",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTaskAudits_UpdaterId",
                table: "AppTaskAudits",
                column: "UpdaterId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTasks_LastUpdaterId",
                table: "AppTasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_syncfiusionTask_TeamId",
                table: "syncfiusionTask",
                column: "TeamId");
